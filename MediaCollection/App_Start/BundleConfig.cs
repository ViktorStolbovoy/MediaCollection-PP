...
namespace MediaCollection
{
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			bundles.Add(new ScriptBundle("~/bundles/Content/DataTableJS").Include(
						"~/Content/DataTable/js/jquery.dataTables.js", 
						"~/Content/DataTable/js/jquery.jeditable.js",
						"~/Content/DataTable/js/jquery.datatables.editable.js",
